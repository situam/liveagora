...
export function BrandingDialog() {
    return <>
        ...
        <p>live agora last updated 2026.06.10, view <a href={`${Env.baseUrl}changelog.txt`} target="_blank" rel="noreferrer">changelog</a> and <a href='https://github.com/situam/liveagora' target='_blank' rel="noopener">source code</a></p>
        <br/>
