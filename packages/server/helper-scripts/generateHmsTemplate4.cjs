...
function main() {
  ...
  template.name = "mitbestimmung_werkstatt3_production"
  ...
  for (let i = 0; i < numSpaces; i++)
  {
    ...
    spacerole.publishParams.allowed = ["video"]
    ...
    stagerole.publishParams.allowed = ["audio", "video"]
    ...
    for (let j = 0; j < numSubspaces[i]; j++)
    {
      ...
      subspacerole.publishParams.allowed = ["audio", "video"]
