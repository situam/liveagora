...
const account_id = "849f61410dd12413960fdda743b64e1f"

exports.handler = async function (event, context) {
  var options = {
    method: 'POST',
    url: `https://api.cloudflare.com/client/v4/accounts/${account_id}/stream/direct_upload`,
    headers: {'Content-Type': 'application/json', 'Upload-Creator': '', 'Authorization': 'Bearer uC4mC0_9s51F43DiZEu1j-QUmh0Hit-Jed67YYSR'},
    data: {
