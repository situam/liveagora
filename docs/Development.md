...
- Cloudflare Images/Stream: for image/video uploads and delivery
- S3-compatible storage bucket: for audio file uploads and delivery (can also be self-hosted, i.e. via Garage or MinIO)

Work is ongoing to migrate to fully open-source/self-hostable alternatives, but this is the working setup for now.

- TODO: document setup of external services
